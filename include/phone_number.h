...
/**
 * @brief Connects to the phonenumber utils daemon.
 *
 * @since_tizen 3.0
 *
...
/**
 * @brief Disconnects from the phonenumber utils daemon.
 *
 * @since_tizen 3.0
 *
 * @return     @c 0 on success,
 ...
 * @remarks For reducing memory size, the phonenumber utils is changed to daemon from library since 3.0.
 ...
 *
 * @pre   phone_number_connect() should be called to open a connection to the phonenumber utils daemon. (Since 3.0)
 * @post   phone_number_disconnect() should be called to close a connection to the phonenumber utils daemon. (Since 3.0)
 *
 */
 ...
 *          as dash or space. It is format of E.164 standard including the country code based on current network.
 *
 * @since_tizen 3.0
 * @privlevel public
